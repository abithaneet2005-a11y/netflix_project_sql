...
-- select emp_name,salary from employees order by salary desc offset 1 limit 1;

select d.department_name,count(e.emp_id)as total_employees from departments d left join employees e on 
